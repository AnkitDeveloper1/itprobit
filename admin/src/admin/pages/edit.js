...
class Edit extends Form {
    ...
    async componentDidMount() {
        ...
        this.setState({
            data: {
                ...
                align_image_left: editPage.data.align_image_left,
                section_image: editPage.data.section_image,
                section_title: editPage.data.section_title,
                section_content: editPage.data.section_content,
                section_listing: editPage.data.section_listing[0],
                status: editPage.data.status,
            },
            addThreeListFormFields: editPage.data.section_three_list,
            addFourListFormFields: editPage.data.section_four_list,
            addMoreSectionFormFields: editPage.data.section_title
        })
    }
    ...
    doSubmit = async () => {
        ...
        if(this.state.data.section_image.length) {
            for (let i = 0 ; i < this.state.data.section_image.length ; i++) {
                if(this.state.data.section_image[i].name) {
                    formData.append("section_image", this.state.data.section_image[i], this.state.data.section_image[i].name);
                }
            }
        }
        // Update the formData object
        if(this.state.data.section_three_image && this.state.data.section_three_image.name) {
            formData.append(
                "section_three_image",
        ...
        if(this.state.data.section_four_image && this.state.data.section_four_image.name) {
            formData.append(
                "section_four_image",
    ...
    render() {
        const { errors, addThreeListFormFields, addFourListFormFields, addMoreSectionFormFields, data } = this.state;
                ...
                <form className="row" encType="multipart/form-data" onSubmit={this.handleOnSubmit}>
                    <div className="col-sm-6">
                        <div className="mb-3">
                            ...
                            <select className="form-control" name="type" onChange={this.handleChange} value={data.type}>
                    ...
                    <div className="col-sm-6">
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" name="title" value={data.title} onChange={this.handleChange} />
                    ...
                    <div className="col-sm-6">
                        <div className="mb-3">
                            ...
                            <select className="form-control" name="layout" onChange={this.handleChange} value={data.layout}>
                    ...
                    <div className="col-sm-12">
                        ...
                        <div className="mb-3">
                            ...
                            <textarea type="text" className="form-control" name="section_one_content" rows="3" value={data.section_one_content} onChange={this.handleChange} />
                    ...
                    <>
                        <div className="col-sm-12">
                            ...
                            <div className="mb-3">
                                ...
                                <textarea type="text" className="form-control" name="section_two_content_1" rows="3" value={data.section_two_content_1} onChange={this.handleChange} />
                        ...
                        <div className="col-sm-12">
                            ...
                            <div className="mb-3">
                                ...
                                <textarea type="text" className="form-control" name="section_two_content_2" rows="3" value={data.section_two_content_2} onChange={this.handleChange} />
                        ...
                        <div className="col-sm-12">
                            ...
                            <div className="mb-3">
                                ...
                                <textarea type="text" className="form-control" name="section_two_content_3" rows="3" value={data.section_two_content_3} onChange={this.handleChange} />
                        ...
                        <div className="col-sm-12">
                            ...
                            <div className="mb-3">
                                ...
                                <textarea type="text" className="form-control" name="section_three_content" value={data.section_three_content} rows="3" onChange={this.handleChange} />
                                ...
                                {addThreeListFormFields.map((x, i) => {
                                    return(<div className="row mt-2" key={i}>
                                        <div className="col-sm-10">
                                            <input type="text" className="form-control" name="section_three_list" value={x} onChange={(e) => this.handleListChange(e, i)} />
                            ...
                            <div className="mb-3">
                                ...
                                {data.section_three_image && <img width={60} src={"/uploads/"+data.section_three_image} />}
                            </div>
                        </div>
                        <div className="col-sm-12">
                            <div className="mb-3">
                            ...
                            <div className="mb-3">
                                ...
                                <textarea type="text" className="form-control" name="section_four_content" rows="3" value={data.section_four_content} onChange={this.handleChange} />
                            ...
                            <div className="mb-3">
                                ...
                                {addFourListFormFields.map((x, i) => {
                                    return(<div className="row mt-2" key={i}>
                                        <div className="col-sm-10">
                                            <input type="text" className="form-control" name="section_four_list" value={x} onChange={(e) => this.handleListChange(e, i)} />
                            ...
                            <div className="mb-3">
                                ...
                                {data.section_four_image && <img width={60} src={"/uploads/"+data.section_four_image} />}
                            </div>
                        </div>
                    </>}
                                        ...
                                        <div className="card-body row">
                                            <div className="col-sm-6">
                                                <div className="mb-3">
                                                    ...
                                                    <select className="form-control" name="align_image_left" onChange={(e) => this.handleListChange(e, index)} value={data.align_image_left[index]}>
                                            ...
                                            <div className="col-sm-6">
                                                <div className="mb-3">
                                                    ...
                                                    {typeof data.section_image[index] === 'string' && data.section_image[index]}
                                            ...
                                            <div className="col-sm-12">
                                                <div className="mb-3">
                                                    ...
                                                    <input type="text" className="form-control" name="section_title" onChange={(e) => this.handleListChange(e, index)} value={data.section_title[index]} />
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <textarea type="text" className="form-control" name="section_content" rows="3" onChange={(e) => this.handleListChange(e, index)} value={data.section_content[index]} />
                    ...
                    <div className="col-sm-6">
                        <div className="mb-3">
                            ...
                            <select className="form-control" name="status" onChange={this.handleChange} value={data.status}>
